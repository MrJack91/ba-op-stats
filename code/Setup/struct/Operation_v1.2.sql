...
--
-- Host: localhost:3306
-- Erstellungszeit: 19. Dez 2016 um 11:34
...
CREATE TABLE `Operation` (
  ...
  `Wochentag_Text` varchar(20) NOT NULL,
  ...
  `Dringlichkeit_Text` varchar(10) DEFAULT NULL,
  ...
  `_invalidTime` tinyint(4) NOT NULL DEFAULT '0',
  `_mistyDate` varchar(10000) DEFAULT NULL,
  ...
  `_time_Prepare` int(11) DEFAULT NULL,
  `_time_minPillarTime` int(11) DEFAULT NULL,
  `_time_ANATime` int(11) DEFAULT NULL,
  `_Zeitprognose` int(11) DEFAULT NULL,
  `_timediff_OP_planned` int(11) DEFAULT NULL,
  `_firstOccurredByPID` tinyint(4) NOT NULL DEFAULT '0'
